...
@Component({
  selector: 'app-signaturre',
  templateUrl: './signaturre.component.html',
  styleUrls: ['./signaturre.component.scss']
})
export class SignaturreComponent implements OnInit, AfterViewInit {
